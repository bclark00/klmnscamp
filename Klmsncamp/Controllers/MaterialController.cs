...
{ 
    public class MaterialController : Controller
    {
        ...
        public ViewResult Index()
        {
            ...
            var materials = db.Materials.Include(m => m.Location).Include(m => m.CorporateAccount).Include(m => m.ParentMaterial).Include(m => m.MaterialCategory).Include(m => m.MaterialGroup).Include(m => m.MaterialType).Include(m => m.ValidationState);

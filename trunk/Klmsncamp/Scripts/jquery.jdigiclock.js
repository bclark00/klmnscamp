...
(function ($) {
    $.fn.extend({
        ...
        jdigiclock: function (options) {
            ...
            var defaults = {
                ...
                lang: 'en',
                am_pm: false,
                weatherLocationCode: 'MEA|TR|TU056|MANISA',
                weatherMetric: 'C',
                weatherUpdate: 0,
                proxyType: 'asp'
            ...
            var regional = [];
            regional['en'] = {
                monthNames: ['Oca', 'Þub', 'Mar', 'Nis', 'May', 'Haz', 'Tem', 'Agu', 'Eyl', 'Eki', 'Kas', 'Ara'],
            ...
            return this.each(function () {
                ...
                html += '<p id="right_arrow"><img src="/content/images/icon_right.png" /></p>';
    ...
    $.fn.getWeather = function (el) {
        ...
        //$.getJSON('http://127.0.0.1:8080/hastakabul/sensewidget/ajax/', function (data) {
            ...
            el.find('#forecast_container').append('<div id="update"><img src="/content/images/refresh_01.png" alt="reload" title="reload" id="reload" />' + el.timeUpdate + '</div>');
